...
export function ProductCard({ product, store, variant = "grid" }: ProductCardProps) {
        ...
        <div className="flex items-start gap-2.5 sm:gap-3">
          ...
          <div className="min-w-0 flex-1">
            <div className="mb-0.5 flex items-center justify-between gap-1.5 text-[10px]">
              <span className="rounded-full bg-slate-100 px-2 py-0.5 font-bold text-slate-600">محصول</span>
              {product.isNew && (
            ...
            <div className="mt-1.5">
              <p className="text-[10px] font-semibold text-slate-400">قیمت محصول</p>
              <div className="mt-0.5 flex items-center gap-1.5">
                <p className="text-base text-slate-900 sm:text-lg">{formatPrice(finalPrice)}</p>
                <p className="text-[11px] text-slate-400 line-through">{formatPrice(product.price)}</p>
              </div>
            </div>
